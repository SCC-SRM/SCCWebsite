		...
		<div id="domainDescRoot">
			...
			<div className="domainsDescriptionContent w-full relative flex flex-col">
				<div className="technicalDesc section text-lg domainDescSection w-fit m-16 p-[5%] shadow-2xl bg-[#1f1e1e] ">
					<div className="font-semibold text-2xl mb-10 domainSubHeading underline decoration-[#d97706]">Technical</div>
				...
				<div className="font-semibold text-2xl mb-10 domainSubHeading underline decoration-[#d97706]">Creatives</div>
				...
				<div className="font-semibold text-2xl mb-10 domainSubHeading underline decoration-[#d97706]">Corporate</div>

...
return (
<>
    <div className="  text-white h-full overflow-x-hidden   bg-gray-900 ">
        ...
        <div className="sm:pb-14 "  >
            <div className="sm:pt-[200px]  flex md:flex-row flex-col  items-center justify-center space-x-10 pr-[80px]  sm:pr-[280px] ">
                <h1 className="  uppercase relative md:rotate-90 rotate-0    tracking-widest sm:text-[100px] text-[80px] font-semibold">Domains
        ...
        <div className=" sm:mt-[200px] mt-[90px] flex items-center justify-center flex-col sm:flex-row space-x-10 ">
            ...
            <div className=" max-w-3xl  space-y-12   ">
                ...
                <p className=" sm:text-3xl text-2xl  font-extralight ">The technical domain focuses on technical skill development and
        ...
        <div className=" sm:mt-[200px] mt-[90px]  flex items-center justify-center flex-col-reverse sm:flex-row  space-x-10 ">
            ...
            <div className="max-w-3xl space-y-10   ">
                <h1 className="uppercase relative text-5xl text-orangeHeader  "><span>Creatives</span>
                    <div className="bg-white absolute -bottom-[100px]   left-[200px]  rotate-90  w-1 h-[180px]  " />
                </h1>
                <p className=" sm:text-3xl sm:max-w-3xl   text-2xl  font-extralight  ">The creative domain focuses on fostering creativity and
        ...
        <div className="  sm:mt-[200px] mt-[90px]  flex items-center justify-center flex-col md:flex-row    space-x-10 ">
            ...
            <div className="max-w-3xl space-y-10   ">
                ...
                <p className="text-2xl  font-extralight ">The corporate domain in our club focuses on building a

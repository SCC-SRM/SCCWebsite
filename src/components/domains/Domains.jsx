        ...
        <div className="  sm:mt-[200px] mt-[90px]  flex items-center justify-center flex-col md:flex-row    space-x-10 ">
          ...
          <div className="max-w-3xl space-y-10   ">
            ...
            <p className="text-2xl  font-extralight ">
              ...
              professional liaison with the public and potential collaborators.
              They work on establishing partnerships with companies and
              organizations building relationships with these entities to secure
              funding, resources, and opportunities for the club and its
              members, thus enhancing the clubs reputation and contacts. This
              can include arranging networking events, internships, and other
              professional development activities. The domain also manages our
              social media and work on conducting events, hackathons and
              workshops to keep the club engaged with the students
            </p>
          </div>
        </div>
      </div>

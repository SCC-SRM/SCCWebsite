    ...
    <>
      <div className="min-h-full mb-20">
        <div className="flex p-0">
          <span className="font-bold text-4xl text-underline-offset: 8px underline decoration-[#F18C00] text-custom1 ml-auto ">
            Upcoming Events
          </span>
        </div>
        ...
        <div className="relative p-4 top-5">
          ...
          <span
            className="font-helvetica font-bold  text-custom1  absolute top-20 left-12 translate-x-1/2"
            style={{ textShadow: "2px 2px 2px grey", fontSize: "10rem" }}
          >
            23'
          </span>

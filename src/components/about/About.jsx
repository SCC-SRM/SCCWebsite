        ...
        <div className="flex flex-col lg:flex-row">
          <div className="flex flex-col justify-center">
            <p className="text-lg mb-4">
              ...
              programming and app development. The club is open to students of
              all skill levels, from those who are just starting out to those
              who have been coding for years.
            </p>
            <p className="text-lg">
              The club was inaugurated and was made open to the students of SRM
              to join on **XYZ date**. Ever since then, we have been striving to
              create new opportunities for our club members to grow in all
              aspects that would help them become better professionals in the
              various fields they would like to have a career in. The club has
              grown from a group of X no. of people to y no. (the present
              strength) of people.
            </p>
          </div>
